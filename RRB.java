...
public class RRB extends IflRRB
{
    ...
    */
    ...
    {
        ResourceCB ResourceToGrant = getResource();   
        int newAvailable = (ResourceToGrant.getAvailable() - getQuantity()); 
        ResourceToGrant.setAvailable(newAvailable);
        
        int newAllocated = (ResourceToGrant.getAllocated(getThread()) + (getQuantity())); 
        ResourceToGrant.setAllocated(getThread(), newAllocated); 
